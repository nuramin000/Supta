...
------------------------------------------
 Author : Mr.Nur amin
 Github : Mr.Nuramin(Follow Must)
 Tools  : Auto Facebook Register
 Contact: +8801836418811
 Version: 1.6
\033[1;37m------------------------------------------""") 
try:
    clear()
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write('\r\r\033[1;37m [NURAMIN-CREATE] \033[1;32mOK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [NUR-AMIN-OK] "+uid+'|'+pas+'|'+coki)
                 ok+=1
